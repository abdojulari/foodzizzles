        ...
        <Fade duration={1000} >
            <div className="relative flex flex-col justify-center items-center mt-10">
                ...
                <div className="absolute flex flex-col items-center w-2/5 text-center">
                    ...
                    <button 
                        className="bg-transparent my-10 text-white border border-white px-10 py-3 font-bold text-xl hover:bg-white hover:text-lemon hover:transition-all hover:border-white"
