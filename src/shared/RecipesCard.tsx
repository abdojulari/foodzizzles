...
const RecipeCard: React.FC<RecipeInterface> = ({ image, name, description, duration, date, category }) => {
    return (
        ...
        <div className="px-6 py-4">
            ...
            <a href="#"
                className="font-semibold text-lg inline-block hover:text-lemon transition duration-500 ease-in-out">{name}</a>
